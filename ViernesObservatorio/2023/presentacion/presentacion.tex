...
\title[]{{\huge CORRIENTES ESTELARES}\\ {\LARGE Aquellos r\'ios de estrellas en la Galaxia y el Universo local}}
...
\frame {\frametitle{Una galaxia de disco típica}\overgang

    \begin{center}
      {Messier 81 (HST)}
      \includegraphics[width=0.9\textwidth]{figures_viernes/Messier_81_HST.jpg}\\
    \end{center}
}
...
\frame {\frametitle{Helmi stream}\overgang
    ...
    \begin{center}
      Satélite Gaia\\
      Nuevos miembros detectados: $\sim 600$ estrellas\\
      \vspace{4mm}
...
\frame {\frametitle{Corrientes estelares en el Universo local}\overgang
%\hspace{-1cm}
...
\begin{center}
  Animación: \textcolor{orange}{1\_GlobularClusterStreamInMWwithSubHalos.mp4} \\
\end{center}
}
...
\begin{center}
  Animación: \textcolor{orange}{2\_FormationSagittariusStreamWithLMC.mp4} \\
\end{center}
}
...
\frame {\frametitle{Corriente Palomar 5\\
\vspace{-0.3cm}
  {\tiny (Odenkirchen 2000+)}}\overgang
  \begin{minipage}[t]{1.0\textwidth}
    \begin{center}
      \textcolor{cyan}{Una corriente estelar que transita por el halo y la barra}\\
      \vspace{0.2cm}
...
\frame {\frametitle{Corriente estelar GD-1\\
\vspace{-0.3cm}
  {\tiny (Grillmair \& Dionatos 2006)}}\overgang
  \begin{minipage}[t]{1.0\textwidth}
    \begin{center}
      \textcolor{cyan}{Una corriente estelar "fría"}\\
      {\tiny (Price-Whelan \& Bonaca 2018)}\\
      \vspace{0.2cm}
      \includegraphics[width=0.99\textwidth]{figures_gd1/GD-1_PriceW-Bonaca2018.jpg}\\
      \vspace{2mm}
...
\frame { \frametitle{Observables de la corriente GD-1\\
\vspace{-0.6cm}
...
\frame { \frametitle{Resultado de ajuste de potencial gravitatorio}\overgang
...
\frame { \frametitle{Curva de rotación Galáctica}\overgang
...
\frame {\frametitle{42 corriente estelares}\overgang
\begin{center}
  Animación: \textcolor{orange}{3\_42StellarStreams.mp4} \\
\end{center}
}

\frame {\frametitle{Atlas global de las fusiones en la Vía Láctea}\overgang
\begin{center}
  \includegraphics[width=0.9\textwidth]{figures_viernes/zFig_JE_clusters_selection.pdf}\\
  {\small Corrientes estelares y cúmulos globulares agrupados en espacio Energía-Momento angular}
\end{center}
}

\frame {\frametitle{Atlas global de las fusiones en la Vía Láctea}\overgang
\begin{center}
  Animación: \textcolor{orange}{4\_AtlasOfStreams.mp4} \\
\end{center}
}

\frame {\frametitle{Fusión de dos galaxias de disco}\overgang
\begin{center}
  Animación 360$^\circ$: \textcolor{orange}{GalaxyCollision} \\
\end{center}
}
